...
export default function PrivacyPolicy() {
    ...
    return (
        <>
            <SEO title='cat baguette | Privacy Policy' description='Feed an insatiable cat in this delightful arcade game, where precision meets fun' iconPath='/cat-baguette/icon.png' previewPath='/cat-baguette/preview.png' />
